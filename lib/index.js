...
function validateOptions(options) {
  if (options.webpackConfigOverrides) {
    assert(typeof options.webpackConfigOverrides !== 'object', 'Webpack config overrides should be an object.');
  }
  if (options.patchCompiler && !(typeof options.patchCompiler === 'function' && options.patchCompiler.length === 1)) {
    throw new TypeError("Expected patchFileSystem to be a function with one parameter, got " + typeof options.patchCompiler);
  }
}
