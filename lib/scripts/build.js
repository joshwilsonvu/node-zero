...
module.exports = async function(entry, options = {}) {
  ...
  let config = webpackConfigure({ env: 'production', entry, paths, useTypescript })
  ...
  if (options.fs) {
    ...
    // compiler.inputFileSystem = compiler.outputFileSystem = fs;
